...
def analyze_ingredients(
    ...
    if not profiles:
        return {
            ...
            "additives_analysis": [],
            "allergens_analysis": [],
            "summary": "This profile has no dietary restrictions selected, so NutriLabel did not find any profile-specific conflicts. Still check the label if you have personal concerns.",
        }
