...
export default function ResultScreen({ route, navigation }) {
  const { productName, ingredientText, analysis, selectedProfiles, fromHistory, nutrition } = useMemo(
    ...
    <LinearGradient colors={colors.gradient} style={styles.flex}>
      <SafeAreaView style={styles.flex}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <Pressable style={[styles.secondaryButton, { borderColor: colors.primary, backgroundColor: colors.card }]} onPress={() => navigation.navigate('AddFood', { productName, nutrition })} accessibilityRole="button" accessibilityLabel="Add product to food log"><Text style={[styles.secondaryText, { color: colors.secondary }]}>Add to Food Log</Text></Pressable>
