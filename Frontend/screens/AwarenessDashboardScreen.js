            ...
            {loading ? (
              ...
              <>
                <View style={styles.kpiRow}>
                  ...
                  <Kpi colors={colors} value="Customer reports" label="Top detection signal" />
                </View>
                ...
                <ChartCard colors={colors} title="How allergen problems are found" subtitle="Customer-reported detections over time.">
