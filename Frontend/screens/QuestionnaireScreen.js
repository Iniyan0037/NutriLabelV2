...
const QUESTIONS = [
  ...
  { id: 'religious', question: 'Do you follow any religious dietary rules?', icon: 'moon', color: '#9C27B0', single: false, options: ['Halal', 'Kosher', 'Jain', 'None'] },
  ...
  { id: 'diet', question: 'What is your dietary preference?', icon: 'leaf', color: '#4CAF50', single: true, options: ['Vegan', 'Vegetarian', 'Eggetarian', 'No restriction'] },
];

const ALL_RESTRICTIONS = ['vegan', 'vegetarian', 'eggetarian', 'Jain', 'halal', 'kosher', 'nut-free', 'dairy-free', 'gluten-free'];
...
const PROFILE_EXPLANATIONS = {
  ...
  kosher: 'Requires ingredients to comply with kosher dietary requirements and may require certification checks.',
        ...
        <SafeAreaView style={styles.flex}>
          <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
              ...
              <TextInput
                style={[styles.input, { backgroundColor: colors.card2, borderColor: profileName.trim() ? colors.border : colors.danger, color: colors.text }]}
                value={profileName}
                onChangeText={setProfileName}
                placeholder="Enter profile name, e.g. Uni lunch profile"
            ...
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]} accessibilityLabel="Generated profile summary">
              ...
              )) : <Text style={[styles.emptyText, { color: colors.muted }]}>No restrictions selected. This profile can still use barcode, OCR, learning and nutrition features.</Text>}
            </View>
